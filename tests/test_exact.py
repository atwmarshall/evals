...
class TestExactMatch:
    ...
    def test_unicode(self):
        assert exact_match("café", "café") == 1.0

    def test_unicode_mismatch(self):
        assert exact_match("cafe", "café") == 0.0


class TestNormalisedMatch:
    def test_identical(self):
        assert normalised_match("hello", "hello") == 1.0

    def test_different(self):
        assert normalised_match("cat", "dog") == 0.0

    def test_case_insensitive(self):
        assert normalised_match("Hello World", "hello world") == 1.0
    ...
    def test_hyphens_stripped(self):
        ...
        assert normalised_match("2024-03-14", "20240314") == 1.0

    def test_underscore_preserved(self):
        # underscore is \w so it is NOT stripped
        assert normalised_match("hello_world", "hello world") == 0.0

    def test_mixed_case_and_punctuation(self):
        assert normalised_match("The Answer: YES.", "the answer yes") == 1.0
